...
from mainsite.utils import redirect_with_data, get_slice_and_page_end #, __ITEMS_NUMBER_IN_A_PAGE
...
def create(request, data, **kwargs):
    if request.method == 'POST':
        ...
        new_receipt = Receipt(creator=creator, payer=payer, payee=payee, total_amount=0, date=date, address=address, notes=notes, company=workplace)
        new_receipt.save()
